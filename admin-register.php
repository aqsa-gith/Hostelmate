  ...
  <form class="form-card" action="admin-register-action.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-left-wrapper">
      <div class="form-left">
        ...
        <div class="field"><label>Hostel Code</label><input type="text" name="hostel_code" placeholder="e.g. H-10" required></div>
        ...
        <div class="divider"></div><h3>Security</h3>
        <div class="grid-2">
      ...
      <div class="image-column">
        <div class="image-block">
          <div class="image-heading">Admin Photo</div>
        ...
        <div class="image-block">
          <div class="image-heading">ID Card</div>
          <label class="image-box">
        ...
        <div class="image-block">
          <div class="image-heading">Staff Card</div>
          <label class="image-box">
