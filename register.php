...
<head>
  ...
  <style>
    * {
    ...
    input:hover,
    select:hover {
      box-shadow: 0 0 15px rgba(13, 58, 128, .4);
    ...
    .register-btn:hover {
      box-shadow: 0 0 25px rgba(13, 110, 253, .7);
    ...
    .tick {
      ...
      animation: showTick 0.5s forwards 1s;
    }
...
<body>
  <div class="marquee">
    <marquee scrollamount="6">Must fill all the fields and register yourself at HostelMate for your hostel updates
    </marquee>
  </div>
    ...
    <form class="form-card" action="register_action.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-left-wrapper">
        <div class="form-left">
          ...
          <div class="field"><label>Phone Number</label><input type="tel" name="phone" placeholder="03XXXXXXXXX"
              required></div>
          <div class="field"><label>CNIC</label><input type="text" name="cnic" placeholder="XXXXX-XXXXXXX-X" required>
          </div>
          <div class="field"><label>Gmail</label><input type="email" name="email" placeholder="example@gmail.com"
              required></div>

          <div class="divider"></div>
          <h3>Account Security</h3>
          <div class="grid-2">
            <div class="field"><label>Password</label><input type="password" name="password"
      ...
      <div class="grid-2">
        <div><label>Degree Type</label><select name="degree" required>
